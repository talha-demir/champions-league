    ...
    <div class="py-12">
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-16">
                    ...
                    <div class="flex space-x-2 justify-center">
                        <div>
                            <button wire:loading.attr="disabled" wire:loading.class="opacity-60" wire:click="generateFixtures" type="button" class="inline-block px-7 py-3 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">
                                Generate Fixtures
                            </button>
                        </div>
                    </div>
        ...
        @else
            ...
            <div class="flex space-x-2 justify-center mt-4">
                <div>
                    <button wire:loading.attr="disabled" wire:click="generateFixtures" type="button" class="inline-block px-7 py-3 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">
                        Continue
                    </button>
                </div>
            </div>
